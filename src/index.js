...
class Board extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <h3>
          <a href="https://anthonyh45.github.io">
        ...
        <div>
          ...
          <div className="board-row">
            ...
            {this.renderSquare(
              1,
              winners[0] === 1 || winners[1] === 1 ? true : false
            )}
            {this.renderSquare(
              2,
              winners[0] === 2 || winners[2] === 2 ? true : false
            )}
          </div>
          <div className="board-row">
            {this.renderSquare(
              3,
              winners[0] === 3 || winners[1] === 3 ? true : false
            )}
            {this.renderSquare(4, winners[1] === 4 ? true : false)}
            {this.renderSquare(
              5,
              winners[1] === 5 || winners[2] === 5 ? true : false
            )}
          </div>
          <div className="board-row">
            {this.renderSquare(
              6,
              winners[1] === 6 || winners[2] === 6 ? true : false
            )}
            {this.renderSquare(
              7,
              winners[0] === 7 || winners[2] === 7 ? true : false
            )}
